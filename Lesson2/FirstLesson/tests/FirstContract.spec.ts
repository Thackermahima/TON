...
describe('FirstContract', () => {
    ...
    beforeEach(async () => {
        ...
        firstContract = blockchain.openContract(await FirstContract.fromInit(20030n));
    ...
    it("should increase", async() => {
        ...
        const countAfter = await firstContract.getCounter()
        console.log("counterAfter - ", countAfter);
        expect(counterBefore).toBeLessThan(countAfter);
    })
